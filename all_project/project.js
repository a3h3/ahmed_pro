...
if (localStorage.getItem('image') === './img/projects/p4.png') {
    let el_link_git = document.querySelector('.link_git');
    el_link_git.href = 'https://a3h3.github.io/foodie-master/';
    // =============================================
    let el_imgs = document.querySelector('.imgs');
    let img = document.createElement('img');
    img.src = '../img/home_all_img/موقع 4/p1.png';
    el_imgs.appendChild(img);
    // ==============================================
    let img2 = document.createElement('img');
    img2.src = '../img/home_all_img/موقع 4/p2.png';
    el_imgs.appendChild(img2);
    // =============================================
    let img3 = document.createElement('img');
    img3.src = '../img/home_all_img/موقع 4/p3.png';
    el_imgs.appendChild(img3);
}
// =================================================================================
if (localStorage.getItem('image') === './img/projects/p5.png') {
    let el_link_git = document.querySelector('.link_git');
    el_link_git.href = 'https://a3h3.github.io/fitlife-master/';
    // =============================================
    let el_imgs = document.querySelector('.imgs');
    let img = document.createElement('img');
    img.src = '../img/home_all_img/موقع 5/p1.png';
    el_imgs.appendChild(img);
    // ==============================================
    let img2 = document.createElement('img');
    img2.src = '../img/home_all_img/موقع 5/p2.png';
    el_imgs.appendChild(img2);
    // =============================================
    let img3 = document.createElement('img');
    img3.src = '../img/home_all_img/موقع 5/p3.png';
    el_imgs.appendChild(img3);
    // =============================================
    let img4 = document.createElement('img');
    img4.src = '../img/home_all_img/موقع 5/p4.png';
    el_imgs.appendChild(img4);
}
...
if (localStorage.getItem('image') === './img/projects/p6.png') {
    let el_link_git = document.querySelector('.link_git');
    el_link_git.href = 'https://a3h3.github.io/hoolix-master/';
    // =============================================
    let el_imgs = document.querySelector('.imgs');
    let img = document.createElement('img');
    img.src = '../img/home_all_img/موقع 6/p1.png';
    el_imgs.appendChild(img);
    // ==============================================
    let img2 = document.createElement('img');
    img2.src = '../img/home_all_img/موقع 6/p2.png';
    el_imgs.appendChild(img2);
    // =============================================
    let img3 = document.createElement('img');
    img3.src = '../img/home_all_img/موقع 6/p3.png';
    el_imgs.appendChild(img3);
    // =============================================
    let img4 = document.createElement('img');
    img4.src = '../img/home_all_img/موقع 6/p4.png';
    el_imgs.appendChild(img4);
    // =============================================
    let img5 = document.createElement('img');
    img5.src = '../img/home_all_img/موقع 6/p5.png';
    el_imgs.appendChild(img5);
}
...
if (localStorage.getItem('image') === './img/projects/p7.png') {
    let el_link_git = document.querySelector('.link_git');
    el_link_git.href = 'https://a3h3.github.io/drew-hpersonal-portfolio-master/';
    // =============================================
    let el_imgs = document.querySelector('.imgs');
    let img = document.createElement('img');
    img.src = '../img/home_all_img/موقع 7/p1.png';
    el_imgs.appendChild(img);
    // ==============================================
    let img2 = document.createElement('img');
    img2.src = '../img/home_all_img/موقع 7/p2.png';
    el_imgs.appendChild(img2);
    // =============================================
    let img3 = document.createElement('img');
    img3.src = '../img/home_all_img/موقع 7/p3.png';
    el_imgs.appendChild(img3);
}
...
if (localStorage.getItem('image') === './img/projects/p8.png') {
    let el_link_git = document.querySelector('.link_git');
    el_link_git.href = 'https://a3h3.github.io/cruds/';
    // =============================================
    let el_imgs = document.querySelector('.imgs');
    let img = document.createElement('img');
    img.src = '../img/home_all_img/موقع 8/p1.png';
    el_imgs.appendChild(img);
    // ==============================================
    let img2 = document.createElement('img');
    img2.src = '../img/home_all_img/موقع 8/p2.png';
    el_imgs.appendChild(img2);
    // =============================================
    let img3 = document.createElement('img');
    img3.src = '../img/home_all_img/موقع 8/p3.png';
    el_imgs.appendChild(img3);
}

// =================================================================================

if (localStorage.getItem('image') === './img/projects/p9.png') {
    let el_link_git = document.querySelector('.link_git');
    el_link_git.href = 'https://a3h3.github.io/Project_in_js_language/';
    // =============================================
    let el_imgs = document.querySelector('.imgs');
    let img = document.createElement('img');
    img.src = '../img/home_all_img/موقع 9/p1.png';
    el_imgs.appendChild(img);
    // ==============================================
    let img2 = document.createElement('img');
    img2.src = '../img/home_all_img/موقع 9/p2.png';
    el_imgs.appendChild(img2);
    // =============================================
    let img3 = document.createElement('img');
    img3.src = '../img/home_all_img/موقع 9/p3.png';
    el_imgs.appendChild(img3);
}

// =================================================================================

if (localStorage.getItem('image') === './img/projects/p10.png') {
    let el_link_git = document.querySelector('.link_git');
    el_link_git.href = 'https://a3h3.github.io/photographer/';
    // =============================================
    let el_imgs = document.querySelector('.imgs');
    let img = document.createElement('img');
    img.src = '../img/home_all_img/موقع 10/p1.png';
    el_imgs.appendChild(img);
    // ==============================================
    let img2 = document.createElement('img');
    img2.src = '../img/home_all_img/موقع 10/p2.png';
    el_imgs.appendChild(img2);
    // =============================================
    let img3 = document.createElement('img');
    img3.src = '../img/home_all_img/موقع 10/p3.png';
    el_imgs.appendChild(img3);
    // =============================================
    let img4 = document.createElement('img');
    img4.src = '../img/home_all_img/موقع 10/p4.png';
    el_imgs.appendChild(img4);
}
